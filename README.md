# Jupyter4DICe
_This project is maintained by [Marco A. Lopez-Sanchez](https://marcoalopez.github.io/)_ - Last update: 2021/04/30
...
- it allows you to record and detail all post-processing step by step, which is advantageous for the reproducibility of the results. This also allows you to create a processing report that you can use as supplementary material in your publications. 
...
- [Loading data from DICe output](https://nbviewer.jupyter.org/github/marcoalopez/strength_envelopes/blob/master/notebooks/Python_basics.ipynb?flush_cache=true)
- [Working with strains](https://nbviewer.jupyter.org/github/marcoalopez/strength_envelopes/blob/master/notebooks/Python_basics.ipynb?flush_cache=true)
- [Working with displacements](https://nbviewer.jupyter.org/github/marcoalopez/strength_envelopes/blob/master/notebooks/Python_basics.ipynb?flush_cache=true)
- [Assessing the performance of the measures](https://nbviewer.jupyter.org/github/marcoalopez/strength_envelopes/blob/master/notebooks/Python_basics.ipynb?flush_cache=true)
